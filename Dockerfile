...
RUN apt-get update && DEBIAN_FRONTEND=noninteractive apt-get -y install git apache2 php php-curl php-zip php-mysql php-mbstring curl libapache2-mod-php php-json cron nano supervisor wget vim
RUN a2enmod rewrite && \
