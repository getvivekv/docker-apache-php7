...
RUN apt-get update && DEBIAN_FRONTEND=noninteractive apt-get -y install git apache2 php php-curl php-zip php-mysql php-imap php-mbstring curl libapache2-mod-php php-json cron nano supervisor wget vim php-redis php-simplexml php-ldap unzip
RUN a2enmod rewrite && \
